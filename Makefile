...
base.tar:
	...
	docker run --name gentoowsl gentoo/stage3:latest /bin/bash -c "emerge --sync; emerge --update --deep --with-bdeps=y @world; emerge --update --deep --with-bdeps=y @system; emerge sudo"
